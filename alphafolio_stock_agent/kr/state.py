...
Defines the state schema for the workflow
"""
from typing import TypedDict, Optional, Any
from kr.schemas import MarketRegimeOutput, StockResearchOutput, StrategyOutput
...
class AgentState(TypedDict):
    ...
    # Input fields
    # ==========================================================================
    symbol: str                     # Stock code (e.g., "005930")
    stock_name: str                 # Stock name (e.g., "삼성전자")
